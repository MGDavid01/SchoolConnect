    ...
    <Card.Content>
      ...
      <View style={styles.actionsRow}>
        <View style={styles.reactionsRow}>
          <TouchableOpacity style={styles.reactionBtn} onPress={() => onReact(post.id, "like")}>
            <IconButton
          ...
          <TouchableOpacity style={styles.reactionBtn} onPress={() => onReact(post.id, "dislike")}>
            <IconButton
          ...
          <TouchableOpacity style={styles.commentBtn} onPress={() => onComment(post)}>
            <IconButton icon="comment-outline" size={20} iconColor={COLORS.textSecondary} />
            <Text style={styles.reactionCount}>
              {post.comments.length} {post.comments.length === 1 ? "comentario" : "comentarios"}
            </Text>
          </TouchableOpacity>
        </View>
        <IconButton icon="share-variant" size={20} onPress={() => { /* Implementar compartir */ }} />
      </View>
    </Card.Content>
  </Card>
)
