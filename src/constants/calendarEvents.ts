type MarkingType = "period" | "dot" | "multi-dot" | "custom"; // Tipos posibles de marcado

interface DateMarking {
  color: string;
  textColor: string;
  startingDay: boolean;
  endingDay: boolean;
...
const markingType: MarkingType = "period";
...
const academicPeriods: MarkedDates = {
  ...generateRange(
    "2024-09-23",
    "2024-09-27",
    ACADEMIC_COLOR,
...
// Exportar el tipo de marcado si es necesario
...
export const CALENDAR_EVENTS_2024_2025: Record<string, CalendarEvent> = {
  "2024-09-23": { dotColor: ACADEMIC_COLOR },
  "2024-10-14": { dotColor: ACADEMIC_COLOR },
  // ...
};
...
export const EVENT_TYPES = {
  ACADEMIC: { color: "#FF0000", label: "Académico" },
  HOLIDAY: { color: "#00FF00", label: "Vacaciones" },
  EXAM: { color: "#0000FF", label: "Examen" }
}
